...
execute_process(
  COMMAND "/usr/bin/git" show-ref "1.3.4"
  WORKING_DIRECTORY "/document/FBX2glTF/build/draco/src/Draco"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("1.3.4" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/1.3.4")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/document/FBX2glTF/build/draco/src/Draco'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/document/FBX2glTF/build/draco/src/Draco'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
